...
namespace UniversalConstants
{
    ...
    constexpr double G_scaled = 6.67430e-1; // Scaled gravitational constant for simulation
    constexpr double EPS0 = 8.854187817e-12; // Vacuum permittivity, units: F/m (farads per meter)
    constexpr double K = 1.0 / (4.0 * M_PI * EPS0); // Coulomb's constant, units: N m^2 C^-2
